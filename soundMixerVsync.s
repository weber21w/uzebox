...
#if (NO_CHANNELS == 1)
#error NO_CHANNELS=1 cannot be used with the stock inline mixer. Supply a custom mixer core or use MIXER_TYPE_VSYNC for the raw-buffer path.
#endif
...
#if ((NO_CHANNELS == 0) && (ENABLE_MIXER == 1) && (MUSIC_VSYNC_PROCESS == 1))
